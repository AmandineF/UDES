	...
	public PanelAide(final JFrame fen, String msg) {
		...
		if(msg.equals("awai"))
			str = "<html><center>Bienvenue sur notre application Awai !<br> Pour utiliser l'application vous devez vous inscrire.<br>"
					+ " Si vous n'êtes pas inscrit, cliquez sur le bouton Inscription.<br> Sinon connectez-vous \u00E0 partir du bouton Connexion."
		...
		if(msg.equals("menu"))
			str = "<html><center>Le menu repr\u00E9sente les diff\u00E9rentes fonctionnalit\u00E9s de notre application.<br>"
					+ "Chaque bulle correspond à une fonctionnalit\u00E9s.<br>"
					...
					+ "La 4e permet de g\u00E9rer ses dépenses et de les partager avec ses contacts.<br>"
		...
		if(msg.equals("inscrit"))
			str = "<html><center>Vous êtes bien inscrit ! Veuillez maintenant vous connecter.</center></html>";
